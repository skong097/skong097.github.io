...
>  **서보 외부 전원 주의**: 차고문/현관문 서보는 토크가 크므로 외부 5V 전원 별도 공급 권장.
...
>  **서보 외부 전원 주의**: 차고와 동일. 대형 서보 사용 시 외부 5V 공급 필수.
...
>  caps가 `"temp"` 로 등록되면 서버 StateManager에서 ds18b20 폴링을 못 찾을 수 있음.
