...
- ✅ 모든 실험 결과는 별도 디렉토리에 저장: `/home/gjkong/dev_ws/yolo/myproj/experiments/rf_tuning_20260206_210753`
...
|------|----------|-----------|--------|----------|------|
| RF Optuna (th=0.50) | 0.9220 | 0.8056 | 0.9775 | 0.8832 | 0.9922 |
| RF Optuna (th=0.79) | 0.9593 | 0.9425 | 0.9213 | 0.9318 | 0.9922 |
...
|------|----------|----------|-----------|--------|----------|------------|
| Baseline (전체) | 181 | 0.9492 | 0.8776 | 0.9663 | 0.9198 | 13.2222 |
| Top-50 | 50 | 0.9458 | 0.8763 | 0.9551 | 0.9140 | 14.5351 |
| Top-80 | 80 | 0.9559 | 0.9043 | 0.9551 | 0.9290 | 14.1574 |
| Top-100 | 100 | 0.9559 | 0.8958 | 0.9663 | 0.9297 | 13.3081 |
| Top-130 | 130 | 0.9627 | 0.9149 | 0.9663 | 0.9399 | 13.2465 |
...
| RF Optuna+Balanced (th=0.79) | 0.9593 | 0.9425 | 0.9213 | 0.9318 | 0.9922 |
...
|------|------|----------|-----------|--------|----------|------|------------|
| 1 | RF Balanced (th=0.59)  | 0.9695 | 0.9444 | 0.9551 | 0.9497 | 0.9953 | 24.9932 |
| 2 | RF weight(Fall=2x, th=0.65)  | 0.9661 | 0.9759 | 0.9101 | 0.9419 | 0.9951 | 25.6594 |
| 3 | RF Top-130 Features  | 0.9627 | 0.9149 | 0.9663 | 0.9399 | 0.9942 | 13.2465 |
| 4 | RF weight(Fall=3x, th=0.46)  | 0.9593 | 0.9053 | 0.9663 | 0.9348 | 0.9945 | 24.9456 |
| 5 | RF weight(Fall=5x, th=0.57)  | 0.9593 | 0.9326 | 0.9326 | 0.9326 | 0.9942 | 24.9741 |
| 6 | RF Optuna (th=0.79)  | 0.9593 | 0.9425 | 0.9213 | 0.9318 | 0.9922 | 46.3568 |
| 7 | RF Optuna+Balanced (th=0.79)  | 0.9593 | 0.9425 | 0.9213 | 0.9318 | 0.9922 | 46.5493 |
| 8 | RF Top-100 Features  | 0.9559 | 0.8958 | 0.9663 | 0.9297 | 0.9945 | 13.3081 |
| 9 | RF Top-80 Features  | 0.9559 | 0.9043 | 0.9551 | 0.9290 | 0.9950 | 14.1574 |
| 10 | RF (threshold=0.40)  | 0.9492 | 0.8627 | 0.9888 | 0.9215 | 0.9956 | 13.2095 |
...
- **실험 결과:** `/home/gjkong/dev_ws/yolo/myproj/experiments/rf_tuning_20260206_210753`
- **본 보고서:** `/home/gjkong/dev_ws/yolo/myproj/experiments/rf_tuning_20260206_210753/RF_TUNING_EXPERIMENT_REPORT.md`

---

**생성 도구:** `rf_tuning_experiment.py`
**생성일:** 2026-02-06 21:12
**저장 경로:** `/home/gjkong/dev_ws/yolo/myproj/experiments/rf_tuning_20260206_210753`