---
title: "ST-GCN 낙상 감지 시스템 개발 프로젝트 보고서"
date: 2026-03-21
draft: true
tags: ["ai-ml"]
categories: ["ai-ml"]
description: "**프로젝트 기간**: 2026-02-03 **작성자**: Stephen Kong **목적**: Random Forest 대비 ST-GCN의 성능 향상 가능성 검증"
---
...
특징:
 ...
 일부 정상을 낙상으로 오판 (False Positive 존재)
```
