---
title: "Home Safe Solution - 모델 성능 비교 분석 보고서"
date: 2026-03-21
draft: true
tags: ["ai-ml"]
categories: ["ai-ml"]
description: "- **비교 모델:** 3개 - **추론 반복 횟수:** 50회 (속도 측정) - **평가 방식:** 각 모델의 고유 테스트 파이프라인 사용"
---

# Home Safe Solution - 모델 성능 비교 분석 보고서
## 생성일: 2026-02-06 10:51
...
| **AUC** | 0.9951 | 0.6417 | 0.9000 |
| **Inference Time** | 0.08 ms | 0.26 ms | 0.25 ms |
...
**생성일:** 2026-02-06 10:51
**저장 경로:** `/home/gjkong/dev_ws/yolo/myproj/scripts/admin/Model_Compare_Report/20260206_105111`