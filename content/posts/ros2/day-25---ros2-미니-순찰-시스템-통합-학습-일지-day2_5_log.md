---
title: "Day 2~5 - ROS2 미니 순찰 시스템 통합 학습 일지"
date: 2026-03-21
draft: true
tags: ["ros2"]
categories: ["ros2"]
description: "> 2026-02-16 (월) - `robot_status_pub.py`: JSON 기반 로봇 상태 발행 (배터리, 위치, 상태) - `status_monitor_sub.py`: 상태 수신 및 배터리 ALERT 모니"
---
