...
categories: ["ros2"]
description: "> GPS-denied Hazard Operation with Swarm Team — 5 Units > 작성일: 2026-03-15 | **v2.1 — Pinky Pro 실제 스펙 반영: 2026-03-15** > "
---

# GHOST-5 기술 연구 보고서

> GPS-denied Hazard Operation with Swarm Team — 5 Units  
> 작성일: 2026-03-15 | **v2.1 — Pinky Pro 실제 스펙 반영: 2026-03-15**  
> 연관 문서: GHOST-5_구축계획서.md, Ghost5_데이터공유방식.md  
> 참고 논문: MEM (Multi-Scale Embodied Memory for VLAs, Physical Intelligence 2025)
...
*본 연구 보고서 v2.0은 설계 리뷰 결과를 완전히 반영한 최종 문서입니다 (드론 미적용 구성). Phase 1 완료 시 v3.0으로 갱신 예정.*
