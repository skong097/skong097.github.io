---
title: "Emergency Call 기능 통합 가이드"
date: 2026-03-21
draft: true
tags: ["dev-tools"]
categories: ["dev-tools"]
description: "**목표:** Emergency Call 버튼 클릭 시 DB에 긴급 호출 로그 저장 및 Dashboard 조치 컬럼에 표시 1. **Monitoring Page**: Emergency Call 버튼 클릭 2. **D"
---
...
def on_emergency_clicked(self):
    ...
    if not recent_fall:
        ...
        no_event_msg.setText(" No recent fall event detected!")
