...
{{< figure src="/images/diagrams/robotics-blog-content-tree.svg" alt="블로그 content 디렉터리 구조: posts(ros2·computer-vision·robotics·ai-ml·dev-tools 카테고리별 글), projects(프로젝트 포트폴리오), about/index.md" >}}
...
{{< figure src="/images/diagrams/robotics-blog-distribution.svg" alt="콘텐츠 확산 구조: Kevin Patrol Dashboard 완성 하나가 GitHub(소스코드+README), 블로그(상세 개발기 시리즈), YouTube(데모 영상), ROS Discourse(공유), LinkedIn(요약+링크) 5개 채널로 확산" >}}
